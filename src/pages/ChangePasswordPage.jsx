...
import useLanguage from '../hooks/useLanguage';
 const ChangePasswordPage = () => {
  ...
  const content = lang === 'en' ? en_data.change_password : mm_data.change_password;
  ...
  const handleSubmit=async(e)=>{
    ...
    await inputSubmit(url,form,'POST','/',content.success);
  ...
  return (
    <div className='px-2 px-sm-3 pt-3 pb-5 my-5' >
        <div className="customForm  py-3 px-2 px-sm-3 rounded-3 border border-white">
            <h4 className="text-center mb-3">{content.title}</h4>
            
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                  <p className='mb-2'>{content.old_password}</p>
                  <input 
                    type='password' 
                    id='current_password'
                ...
                <div className="mb-3">
                  <p className='mb-2'>{content.new_password}</p>
                  <input 
                  type='password' 
                  className="rounded-3 form-control" 
                  id='password'
                ...
                <div className="mb-3">
                  <p className='mb-2'>{content.confirm_password}</p>
                  <input 
                  type='password' 
                  className="rounded-3 form-control" 
